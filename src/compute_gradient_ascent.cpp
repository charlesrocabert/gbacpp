...
void readArgs( int argc, char const** argv, std::string &path, std::string &name, std::string &condition, double &initial_dt, double &max_t, bool &save, std::string &output_path );
...
int main(int argc, char const** argv)
{
  ...
  bool        save       = false;
  std::string output     = "";
  readArgs(argc, argv, path, name, condition, initial_dt, max_t, save, output);
 ...
 * \return   \e void
 */
void readArgs( int argc, char const** argv, std::string &path, std::string &name, std::string &condition, double &initial_dt, double &max_t, bool &save, std::string &output )
{
  if (argc == 1)
  {
